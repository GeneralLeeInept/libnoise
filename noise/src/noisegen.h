...
namespace noise
{
  ...
  double LIBNOISE_API GradientCoherentNoise3D (double x, double y, double z, int seed = 0,
  ...
  /// to it.
  double LIBNOISE_API GradientNoise3D (double fx, double fy, double fz, int ix, int iy,
    int iz, int seed = 0);
  ...
  /// always returns the same output value if the same input value is passed
  /// to it.
  int LIBNOISE_API IntValueNoise3D (int x, int y, int z, int seed = 0);
  ...
  /// For an explanation of the difference between <i>gradient</i> noise and
  /// <i>value</i> noise, see the comments for the GradientNoise3D() function.
  double LIBNOISE_API ValueCoherentNoise3D (double x, double y, double z, int seed = 0,
    NoiseQuality noiseQuality = QUALITY_STD);
  ...
  /// always returns the same output value if the same input value is passed
  /// to it.
  double LIBNOISE_API ValueNoise3D (int x, int y, int z, int seed = 0);
